...
const itemNBT = {
    ...
    "Enchanted Wheat": {"id":"minecraft:wheat","Count":1,"tag":{"ench":[],"HideFlags":254,"display":{"Lore":["§a§lUNCOMMON"],"Name":"§aEnchanted Wheat"},"ExtraAttributes":{"id":"ENCHANTED_WHEAT"}},"Damage":0},
    "Enchanted Hay Bale": {"id":"minecraft:hay_block","Count":1,"tag":{"ench":[],"HideFlags":254,"display":{"Lore":["§9§lRARE"],"Name":"§9Enchanted Hay Bale"},"ExtraAttributes":{"id":"ENCHANTED_HAY_BLOCK"}},"Damage":0},
