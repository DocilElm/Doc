...
const createCustomEvent = (name, invokeFn) => customTriggers.set(name.toLowerCase(), invokeFn)
...
createCustomEvent("command", (fn, commandName) =>  register("command", fn).setName(commandName).unregister())
...
createCustomEvent("step", (fn, stepAmount) => register("step", fn).setFps(stepAmount).unregister())

createCustomEvent("chat", (fn, criteria) => register("chat", fn).setCriteria(criteria))
...
createCustomEvent("soundPlay", (fn, criteria) => register("soundPlay", fn).setCriteria(criteria).unregister())
